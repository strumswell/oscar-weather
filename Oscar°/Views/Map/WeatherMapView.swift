...
struct WeatherMapView: UIViewRepresentable {
    ...
    func makeUIView(context: Context) -> MLNMapView {
        ...
        weatherMapLogger.info("map view created role=\(userActionAllowed ? "fullscreen" : "preview", privacy: .public)")
    ...
    final class Coordinator: NSObject, MLNMapViewDelegate {
        ...
        func blocked(_ reason: String?) {
            ...
            if let reason {
                ...
                weatherMapLogger.info("sync blocked [\(role, privacy: .public)]: \(reason, privacy: .public)")
            }
        }
        ...
        nonisolated func mapView(_ mapView: MLNMapView, didFinishLoading style: MLNStyle) {
            MainActor.assumeIsolated {
                weatherMapLogger.info("style loaded role=\(self.parent.userActionAllowed ? "fullscreen" : "preview", privacy: .public)")
