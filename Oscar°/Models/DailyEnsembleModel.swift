...
enum DailyEnsembleModel: String, CaseIterable, Identifiable {
  ...
  var menuSubtitle: String {
    ...
    case .ecmwfIFS025Ensemble: return String(localized: "25 km · 15 Tage")
    case .googleWeatherNext2Ensemble: return String(localized: "25 km · 15 Tage")
    case .ncepAIGFS025: return String(localized: "25 km · 16 Tage")
    case .ncepGEFS05: return String(localized: "50 km · 35 Tage")
    case .iconGlobalEPS: return String(localized: "26 km · 7,5 Tage")
    case .iconEUEPS: return String(localized: "13 km · 5 Tage")
    }
  }
